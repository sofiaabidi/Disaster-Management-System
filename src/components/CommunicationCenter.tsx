    ...
    <div className="space-y-6">
          ...
          <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-900 mt-1">{new Date(selectedMessage.timestamp).toLocaleString()}</p>
              </div>
              <div className="flex justify-end space-x-2">
      ...
      {filteredMessages.length === 0 && (
        <Card className="p-12 text-center">
          ...
          <p className="text-gray-600">Try adjusting your search criteria or send a new message.</p>
        </Card>
      )}
    </div>
  );
